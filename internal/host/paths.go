...
func DefaultPaths(root string) Paths {
	...
	return Paths{
		...
		MonitoringRoot:     join("var/lib/omurga/services/monitoring"),
		MonitoringConfig:   join("etc/omurga/monitoring"),
		MonitoringPassword: join("etc/omurga/monitoring/grafana-admin-password"),
...
func (p Paths) ManagedDirectories() []Directory {
	return []Directory{
		...
		{Path: p.MonitoringConfig, Mode: 0o700},
